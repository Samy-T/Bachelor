...
def parse_args():
    ...
    parser.add_argument('--video_root', type=str, default='20bn-something-something-v2-video')
    parser.add_argument('--frame_root', type=str, default='20bn-something-something-v2')
    parser.add_argument('--anno_root', type=str, default='Labels')
...
def extract(video, tmpl='%06d.jpg'):
    cmd = 'ffmpeg -i \"{}/{}\" -threads 1 -vf scale=-1:100 -q:v 0 \"{}/{}/%06d.jpg\"'.format(args.video_root, video, args.frame_root, video[:-5])
    os.system(cmd)
