...
from parse_file_list import (parse_directory, parse_ucf101_splits)
...
def parse_args():
    ...
    parser.add_argument(
        '--rgb-prefix', type=str, default='frame', help='prefix of rgb frames')
    parser.add_argument(
        '--flow-x-prefix',
        type=str,
        default='flow_x_',
...
def main():
    ...
    if args.dataset == 'ucf101':
        ...
        raise ValueError(
            f"Supported dataset is 'ucf101', but "
            f'got {args.dataset}')
